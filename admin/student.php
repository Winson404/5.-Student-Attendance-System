	...
	<body style="background-color:#e6f2ff;">
		...
		<div class = "container-fluid" style = "margin-top:70px;">
				...
				<div class = "modal-dialog" role = "document">
					<div class = "modal-content panel-info">
						<div class = "modal-header panel-heading">
							...
							<h4 class = "modal-title" id = "myModallabel">Create new student</h4>
						</div>
						<form method = "POST" action = "save_student_query.php" enctype = "multipart/form-data" style="padding: 10px 20px;">
				...
				<div class = "modal-dialog" role = "document">
					<div class = "modal-content ">
						<div class = "modal-body">
							...
							<br />
							<center><a class = "btn btn-primary remove_id" ><span class = "glyphicon glyphicon-trash"></span> Yes</a> <button type = "button" class = "btn btn-secondary" data-dismiss = "modal" aria-label = "No"><span class = "glyphicon glyphicon-remove"></span> No</button></center>
						</div>
					</div>
				</div>
			</div>
			...
			<div class = "well col-lg-12">
				<button class = "btn btn-primary" type = "button" href = "#" data-toggle = "modal" data-target = "#add_student"><span class = "glyphicon glyphicon-plus"></span> Create new </button>
				<br />
				<br />
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr class="alert-info">
							...
							<td>
								<a class = "btn btn-success  estudent_id" name = "<?php echo $f_student['student_id']?>" href = "#" data-toggle = "modal" data-target = "#edit_student"><span class = "glyphicon glyphicon-edit"></span></a>
								<a class = "btn btn-danger rstudent_id" name = "<?php echo $f_student['student_id']?>" href = "#" data-toggle = "modal" data-target = "#delete"><span class = "glyphicon glyphicon-remove"></span></a> 
							</td>
						</tr>
						<?php
							}
